...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    if load_pretrain_weights:
        weights_dict = torch.load("./backbone/mask_rcnn_convnext_tiny_1k_3x.pth", map_location="cpu")
...
def main(args):
    ...
    train_dataset = VOCInstances(data_root, year="2007", txt_name="train.txt", transforms=data_transform["train"])
    train_sampler = None
